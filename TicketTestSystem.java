...
public class TicketTestSystem {
    ...
    public static void main(String[] args) {
        ...
        /*/ Enable testing here, just remove the *
        ...
        newGuest1.setTicket(new SeasonTicket(LocalDate.of(2017,9,15),LocalDate.of(2017, 12,31),55,25));

        System.out.println("When a SeasonTicket is set, with the Object from Type Customer it will return "+newGuest1.isMember() + " for the isMember check!");

        newMember.setTicket(new SeasonTicket(LocalDate.of(2017,1,1),LocalDate.of(2017,12,31),95,55));
        System.out.println(newMember.firstName+" "+newMember.lastName+" is a member "+newMember.isMember()+" and his member ID is " + newMember.getMemberID());
        Entry entry = new Entry();
        System.out.println("Testing if the fist name and last name, are the same as on the ticket: "+entry.checkName(newMember));
        System.out.println("Testing if the game date on the ticket is valid: " + entry.checkTicket(newMember));

        //*/


        /*//Enable Testing, just remove the *!
        // is old enough to buy anything
        Member member1 = new Member("Nosu", "Red", LocalDate.of(1994, 7, 11),55);
        // member2 is not old enough to buy alcohol
        Member member2 = new Member("Kuroha","Demon",LocalDate.of(2010,12,24),44);
        // membership expired
        Member member3 = new Member("Aku","Metzu",LocalDate.of(1994,7,11),66);
        ...
        member1.setTicket(new SeasonTicket(LocalDate.of(2017, 1, 1),LocalDate.of(2017, 12, 31), 55,14));
        member2.setTicket(new SeasonTicket(LocalDate.of(2017, 1, 1),LocalDate.of(2017, 12, 15),55,5));
        member3.setTicket(new SeasonTicket(LocalDate.of(2017, 9, 15),LocalDate.of(2017, 9, 16), 55,5));
        ...
        member1.getTicket().modAccountBalance(50.0);
        ...
        for(Customer c: validDateCustomers){
            ...
            // add the valid tickets to a new list
                ...
                System.out.println("Your ticket is valid " +c.firstName + " enjoy standing!" );
            } else{
            validBlockSeat.add(c);
            System.out.println("Your ticket is valid " +c.firstName);
            }
        ...
        for(Customer c: validBlockSeat){
            System.out.println( c.firstName +" enjoy the game!" );
        }
